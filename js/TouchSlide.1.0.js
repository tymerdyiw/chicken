    ...
    var W = function() {
      ...
      , Y = function(a) {
        var b = ("leftLoop" == i ? r + 1 : r) + a
          , c = function(a) {
            for (var b = m.children[a].getElementsByTagName("img"), c = 0; b.length > c; c++)
    ...
    var _ = function(a) {
      ...
      , ab = function(a) {
        if (!H || !(a.touches.length > 1 || a.scale && 1 !== a.scale)) {
            ...
            if (D = b.pageX - B,
            E = b.pageY - C,
            O === void 0 && (O = !!(O || Math.abs(D) < Math.abs(E))),
            !O) {
